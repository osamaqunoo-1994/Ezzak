...
class MyDebtChargeWaysActivity : ParentActivity() {
    ...
    private fun setActions() {
        charge_lay.onClick {
            Util.openUrl(this@MyDebtChargeWaysActivity, Constant.PAYMENT_URL+"/"+mPrefs?.user?.id)
        }
    ...
    private fun openCheckOut(type:String,checkoutId:String){
        ...
        checkoutSettings.shopperResultUrl = "ezzakclientcharge://result"
